...
class _QuizPageState extends State<QuizPage> {
  ...
  final List<Question> questionsList = [
    Question('Thủ đô của Việt Nam là Hà Nội?', true),
    Question('Tokyo là thủ đô của Hàn Quốc?', false),
    Question('Bitcoin là một loại tiền kỹ thuật số', true),
    Question('1 + 1 = 2 ?', true),
  ];
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        backgroundColor: Color.fromARGB(255, 104, 227, 151),
        body: _body(),
      ),
    );
  }
